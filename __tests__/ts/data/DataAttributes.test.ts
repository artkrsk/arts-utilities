...
describe("DataAttributes", () => {
	...
	describe("parseAttribute function", () => {
		...
		it("should parse deeply nested data attribute", () => {
			const attr: IDataAttribute = {
				name: "data-widget-settings-animation-duration",
				value: "300",
			};
			const result = {};
		...
		it("should parse with custom separator", () => {
			const attr: IDataAttribute = {
				name: "data-api__config__timeout",
				value: "1000",
			};
			const result = {};
	...
	describe("parseDataAttributes function", () => {
		...
		it("should handle complex nested structure", () => {
			mockElement.setAttribute(
				"data-widget-settings-animation-duration",
				"300",
			);
			mockElement.setAttribute(
				"data-widget-settings-animation-easing",
				"ease-out",
			);
