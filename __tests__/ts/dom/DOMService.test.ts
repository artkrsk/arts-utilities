...
describe("DOMService", () => {
	...
	describe("querySelector", () => {
		...
		it("should handle errors gracefully", () => {
			// @ts-expect-error - Force error by using invalid selector
			const element = DOMService.querySelector(document, "###");
			expect(element).toBeNull();
		});
	});
	...
	describe("querySelectorAll", () => {
		...
		it("should handle errors gracefully", () => {
			// @ts-expect-error - Force error with invalid selector
			const elements = DOMService.querySelectorAll(document, "###");
			expect(elements).toEqual([]);
		});
	});
	...
	describe("getAttribute", () => {
		...
		it("should handle errors gracefully", () => {
			try {
				// @ts-expect-error - Testing with invalid args
	...
	describe("hasAttribute", () => {
		...
		it("should return false for non-existent attributes", () => {
			const hasAttribute = DOMService.hasAttribute(
				childElement,
				"non-existent",
			);
	...
	describe("setAttribute", () => {
		...
		it("should set data attributes", () => {
			...
			expect(childElement.getAttribute("data-config")).toBe(
				'{"theme": "dark"}',
			);
		...
		it("should handle null element gracefully", () => {
			...
			expect(() =>
				DOMService.setAttribute(null, "test", "value"),
			).not.toThrow();
		});

		it("should handle empty attribute name gracefully", () => {
			expect(() =>
				DOMService.setAttribute(childElement, "", "value"),
			).not.toThrow();
		});

		it("should handle undefined attribute name gracefully", () => {
			expect(() =>
				DOMService.setAttribute(childElement, undefined, "value"),
			).not.toThrow();
		});

		it("should handle undefined value gracefully", () => {
			expect(() =>
				DOMService.setAttribute(childElement, "test", undefined),
			).not.toThrow();
		...
		it("should handle errors gracefully", () => {
			...
			// @ts-expect-error - Testing with mock element
			expect(() =>
				DOMService.setAttribute(mockElement, "test", "value"),
			).not.toThrow();
		});
	});
	...
	describe("html", () => {
      ...
      `;
		...
		it("should work with different element types", () => {
			...
			expect(DOMService.html(section)).toBe(
	...
	describe("contains", () => {
		...
		it("should handle errors gracefully", () => {
			try {
				// @ts-expect-error - Force error with invalid args
	...
	describe("toggleClasses", () => {
		it("should toggle multiple space-separated classes", () => {
			...
			const results1 = DOMService.toggleClasses(
				childElement,
			...
			// Toggle them off
			const results2 = DOMService.toggleClasses(
				childElement,
				"class1 class2 class3",
			);
	...
	describe("createElement", () => {
		...
		it("should throw error for empty tag name", () => {
			expect(() => DOMService.createElement("")).toThrow(
